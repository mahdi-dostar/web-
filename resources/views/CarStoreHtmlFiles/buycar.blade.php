...
<html lang="en-us">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('CarStore/css/buycar.css')}}">
...
<div class="img">
    ...
    <h1 class="wellcome">Wellcome to our Car Store <br>have the best services</h1>
    <p class="fill">Fill the bellow information to purchase the best car</p>
    <img class="bigcar"src="{{asset('CarStore/image/track.png')}}" width="300px" height="200px">
</div>
<br><br><br>
<div class="form">
    <div class="form1">
        <b><p class="text-white">fill the form to buy your favorite car!<br></p></b>

        <form action="/form" method="post">
          @csrf
    Fullname: <br><input type="text"  name="name" placeholder="Please Enter your fullname..." onblur="user();" id="user">
    <span id="users"></span>
    <br>
    Car model: <br><input type="text" name="model" placeholder="Please Enter a Car model..." onblur="last();" id="last">
    <span id="lasts"></span>
    <br>
    Car name: <br><input type="text"name="carname" placeholder="Please Enter a Car name..." onblur="last();" id="last">
    <span id="lasts"></span>
    <br>
    Car price: <br><input type="text" name="price" placeholder="Please Enter the car price..." onblur="email();" id="email">
    <span id="emails"></span>
    <br>
    Email: <br><input type="email" name="email" placeholder="Please Enter your email..." onblur="email();" id="email">
    <span id="emails"></span>
    <br>
    <!-- Gender: Male<input type="radio" name="name">Female<input type="radio" name="name"><br> -->
    Comment:<br><textarea cols="30" rows="5" placeholder="comment" name="text"></textarea><br><br>
    <button type="submit" id="send" onclick="send();">purchase</button>
